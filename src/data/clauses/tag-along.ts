...
- 매수자가 특정 주주(창업자)의 지분만 원한다는 이유로 Tag-Along을 형해화하지 못하도록 '우회 매각 금지' 조항 추가`,
  ...
  legal_check: {
    applicable_laws: [
      ...
      {
        name: "자본시장법 제147조 (주식등의 대량보유 등의 보고)",
        relevance:
          "Tag-Along 행사로 상장회사 등의 5% 이상 보유자 지분이 변동되는 경우 대량보유 보고 의무가 문제될 수 있음. 비상장사에는 직접 적용되지 않으나 상장 전환 또는 상장사 거래에서는 별도 확인 필요.",
        url: "https://www.law.go.kr/법령/자본시장과금융투자업에관한법률",
      },
      {
        name: "벤처투자조합 규약 및 내부 운용기준",
        relevance:
          "벤처투자조합이 투자자인 경우, Tag-Along 행사를 통한 구주 매각 참여는 조합의 투자금 회수 수단에 해당합니다. 조합 규약상 구주 매각 참여 가능 여부 및 절차를 사전에 확인해야 하며, 조합 존속기간 내 투자금 회수를 위한 수단으로도 활용될 수 있습니다.",
      },
    ],
    risk_level: "yellow",
    issues: [
  ...
  war_stories: [
    {
      title: "창업자만 프리미엄 받고 exit — 투자자는 소수주주로 방치",
      situation:
        "창업자(35% 보유)가 대기업 계열사에 주당 50,000원(투자 당시 대비 2배)에 자신의 지분을 전량 매각했습니다. Tag-Along 30일 통지 절차를 거치지 않고 바로 계약을 체결·이행했습니다.",
      consequence:
        "투자자(15% 보유)는 같은 가격에 함께 팔 기회를 원천 차단당했습니다. 새 대주주(대기업)는 자체 사업과 시너지를 내겠다며 독자 경영을 선언하고, IPO 일정을 백지화했습니다. 투자자는 비상장 소수주주로 남아 EXIT 길이 완전히 막혔습니다.",
      lesson:
        "Tag-Along은 '좋은 EXIT 기회를 창업자만 독식하지 못하게' 하는 장치입니다. 한번 놓친 기회는 다시 오지 않을 수 있습니다.",
    },
  ],
};
