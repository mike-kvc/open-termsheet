    ...
    applicable_laws: [
      {
        name: "상법 제344조 (종류주식)",
        relevance:
          "잔여재산분배에 관한 우선주 발행의 법적 근거. 정관에 우선분배 내용을 명시해야 효력의 근거가 됨.",
        url: "https://www.law.go.kr/법령/상법",
      },
      {
        name: "상법 제538조 (잔여재산의 분배)",
        relevance:
          "청산 시 잔여재산 분배 순서. 우선주의 분배 우선권은 정관 기재 사항.",
        url: "https://www.law.go.kr/법령/상법",
      },
      {
        name: "상법상 주주평등 원칙 및 종류주식 규율",
        relevance:
      ...
      },
      {
        ...
        relevance:
          "벤처투자조합이 청산 또는 투자회수 시 조합원(LP)에 대한 분배 절차는 통상 개별 조합 규약에서 구체화됩니다. 투자계약상 liquidation preference(우선분배) 구조는 조합의 분배 규정과 정합성을 갖추어야 하며, 분배 우선순위와 배율이 조합 규약상 허용 범위 내에 있어야 합니다.",
      },
      {
