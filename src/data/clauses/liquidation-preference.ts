...
- 시리즈가 쌓일수록 전체 preference stack이 커지므로, 초기부터 구조를 신경 써야 합니다`,
  ...
  legal_check: {
    applicable_laws: [
      ...
      {
        name: "벤처투자촉진에 관한 특별법 제50조 (투자금의 회수)",
        relevance:
          "벤처투자조합이 투자자인 경우, M&A나 청산 시 잔여재산 분배는 조합의 투자금 회수 규정과 연동됩니다. 조합원에 대한 분배 절차 및 우선순위가 투자계약상 liquidation preference 구조와 정합성을 갖추어야 합니다.",
      },
    ],
    risk_level: "yellow",
    issues: [
