...
const faqs: FaqItem[] = [
  {
    ...
    laws: ["상법 제345조 (주식의 상환)", "벤처투자조합 규약 및 내부 운용기준"],
  },
  {
    ...
    laws: ["상법 (이사회/주주총회 결의의 하자)", "벤처투자조합 규약 및 GP 내부 승인기준"],
  },
  {
    ...
    laws: [
      "상법 제346조 (전환주식)",
      "벤처투자조합 규약 및 LP 보고 기준",
    ],
  },
  {
    question: "IPO 시 RCPS를 보통주로 전환하면 어떤 권리를 잃나요?",
    answer:
      "보통주 전환 시 RCPS의 주식상 우선권은 원칙적으로 소멸합니다: 상환권, 배당 우선권, 잔여재산분배 우선권, Anti-dilution에 따른 전환가격 조정 구조 등이 더 이상 같은 방식으로 작동하지 않습니다. 다만 사전동의권, 정보권, Put Option, 손해배상 등 계약상 권리는 투자계약의 종료 조항과 존속 조항에 따라 달라집니다. IPO 완료 시 계약상 권리 상당 부분을 종료시키는 구조가 많지만, 비밀유지·손해배상·분쟁해결 등은 별도 존속할 수 있으므로 계약 문구를 확인해야 합니다.",
    laws: [
      "상법 제346조 (전환주식)",
  ...
  },
  {
    ...
    answer:
      "벤처투자조합은 규약상 존속기간과 청산 절차가 정해져 있어, 만기가 가까워지면 보유 지분의 회수 전략을 검토하는 경우가 많습니다. 잔여 투자 지분의 처분 및 LP 분배 방식은 개별 조합 규약과 관련 법령에 따라 달라집니다. RCPS의 존속기간(통상 10년)과 펀드 존속기간(통상 8~10년, 연장 가능)이 불일치하면 문제가 될 수 있습니다. 펀드 만료가 임박하면 투자자는 Secondary 매각, 상환권 행사, 또는 보통주 전환 후 매각을 시도합니다. 이 시기에 매도 압력이 커져 할인 매각될 수 있습니다.",
    laws: [
      "벤처투자조합 규약의 존속기간 및 청산 조항",
      "벤처투자조합 규약의 분배 및 회수 조항",
    ],
  },
  {
    question: "RCPS나 CPS는 항상 무의결권 우선주인가요?",
    answer:
      "아닙니다. RCPS/CPS의 의결권 유무와 제한 범위는 정관 및 발행조건에 따라 달라집니다. 의결권 있는 우선주, 특정 사항에만 의결권이 제한되는 우선주, 의결권이 배제되었다가 배당 미지급 등 일정 사유 발생 시 부활하는 우선주가 모두 가능할 수 있습니다. 의결권을 배제하거나 제한하는 종류주식을 발행하는 경우에는 상법상 정관 기재사항과 발행주식총수 한도 등 별도 요건을 확인해야 합니다.",
    laws: [
      "상법 제344조 (종류주식)",
  ...
  {
    question: "투자금 납입 이후에는 주총이나 등기를 어떻게 진행하나요?",
    answer:
      "일반적인 비상장 스타트업의 제3자배정 유상증자에서는 납입 후 새로 주총을 여는 것이 기본 절차는 아닙니다. 정관 변경, 종류주식 발행 근거 마련, 제3자배정 통지 또는 전원 동의, 신주발행 결의는 보통 납입 전에 끝나 있어야 합니다. 납입기일 다음 날부터 투자자는 주주 지위를 취득하고, 회사는 주주명부와 Cap Table을 업데이트합니다. 이후 납입기일 다음 날부터 통상 2주 이내에 본점 소재지 관할 등기소에 자본금 및 발행주식 총수 변경등기를 신청합니다. 다만 투자자 지명 이사 선임, 스톡옵션 풀 조정, 추가 정관 변경처럼 계약에서 별도로 정한 post-closing 의무가 있으면 그 범위에서 주총이나 이사회가 추가로 필요할 수 있습니다.",
    laws: [
      "상법 제416조 (발행사항의 결정)",
      "상법 제418조 (신주인수권)",
      "상법 제423조 (주주가 되는 시기)",
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <header className="mb-10">
        ...
        <LegalDisclaimer context="general" className="mt-6" />
      </header>
